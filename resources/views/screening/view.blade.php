        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container">
                    ...
                    <strong>Screening Status <font color="blue">{{ $name }}</font></strong>
                    </nav>
                        <form class="row g-3" role="form" method="POST" action="{{ route('screeningupdate') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <input class="form-check-input" type="checkbox" value="fb" name="findprogram[]" <?php foreach ($list as $rslt1) : if ($rslt1 == 'fb') { ?> checked <?php } endforeach; ?> />
