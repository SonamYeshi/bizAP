                        ...
                        @include('sweetalert::alert')
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <h5>Training Applications for Shortlisting</h5>
                                </div>
                            </div>
                                <div class="col-md-12 text-center">
                                    <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                <thead class="thead-light">
                                        <tr>
                                            ...
                                            <td>
                                                <button class='bbtn btn-primary btn-sm' target="_blank" data-toggle='modal' data-target="#addRoleModel" style="text-decoration: none; float:right;">Generate
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('sl_update') }}" accept-charset="utf-8" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="form_name" type="number" name="cohortopenno" class="form-control" placeholder="Eenter Number" required>
                        </div>
                    </div>
