        ...
        @include('flash-message')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h5>Interview Panel Members</h5>
                    <a class='btn btn-warning  btn-sm pull-right' data-toggle='modal' data-target="#addCountryModal">Add Panel Member</a>
                </div>
            </div>
            ...
            <table id="example" class="table table-bordered table-sm table-striped">
               ...
               <?php $i = 1;
                ...
                <tr>
                    <td><?php echo $i;?></td>
                    <td><?php echo App\Models\Training::where('id', $t->trainingid)->value('training_title');?></td>
                    <td><?php echo $t->name;?></td>
                    <td><?php echo $t->designation;?></td>
                    <td><?php echo App\Models\Panelrole::where('id', $t->role)->value('rolename');?></td>
                    <td>
                    ...
                    <a href="{{route('delete_ip',['id'=>$t->id])}}" onclick='return confirm("Are you sure to Delete ?")' class="btn btn-danger btn-sm">Delete</a>
                    </td>
                    </tr>
                    <?php $i++;
                    endforeach;
             ...
             <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('interviewpanel/edit')}}">
        </div>
    </div>
  </div>
...
<div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="POST" action="{{ route('interviewpaneladd') }}">
      {{ csrf_field() }}
...
<div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('update_panelmember') }}">
          {{ csrf_field() }}
          <div class='form-group'>
        <label for='type' class='col-xs-4 control-label'>Training<font color="red">*</font></label>
