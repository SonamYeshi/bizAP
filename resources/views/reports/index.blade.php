                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group"> <label for="form_name"></label>
                                                <input type="submit" id="save" name="submit" class="btn btn-success" value="Search" style="float: right;">
                                            </div>
                                        </div>
                                    </div>
                                 </form>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($allapplication as $app) :  ?>
                                            <tr class="table-primary">
                                                ...
                                                <td style="font-size: 14px; text-align: right;"><font color="blue"><?php echo number_format($app->actual_disbursed); ?></font></td>
                                                <td style="font-size: 14px; text-align: right;"><font color="green"><?php echo number_format(App\Models\Repayments::where('cid', $app->cid)->sum('emi_amount'));
