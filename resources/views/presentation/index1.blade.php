...
<div class="modal-content">
      ...
      {{ csrf_field() }}
        ...
        <div class="col-xs-6">
        <input type="date" class="form-control form-control-sm" id="pptdate" name="pptdate" />
        </div>
        </div>
        <div class="form-group">
        <label for="description" class="col-xs-4 control-label">Presentation Time<font color="red">*</font></label>
        <div class="col-xs-6">
        <input type="time" class="form-control form-control-sm" id="ppttime" name="ppttime" >
        </div>
        </div>
      </div>
...
<div class="modal-content">
        ...
        <label for="description" class="col-xs-4 control-label">Presentation Date<font color="red">*</font></label>
        <div class="col-xs-6">
        <input type="date" class="form-control form-control-sm" id="epptdate" name="pptdate" />
        </div>
        </div>
        <div class="form-group">
        <label for="description" class="col-xs-4 control-label">Presentation Time<font color="red">*</font></label>
        <div class="col-xs-6">
        <input type="time" class="form-control form-control-sm" id="eppttime" name="ppttime" >
        </div>
        </div>
        </div>
        <div class="modal-footer">
