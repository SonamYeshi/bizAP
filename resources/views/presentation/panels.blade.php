        ...
        @include('flash-message')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h5>Presentation Panel Members</h5>
            ...
            <thead class="thead-light">
                <tr>
                    ...
                    <th style="color:#0553a1;font-weight: 500;font-size: 15px;">DHI Fund</th>
               ...
               <?php $i = 1;
                ...
                <tr>
                    ...
                    <td style="font-size: 14px;"><?php echo App\Models\Funding::where('id', $t->fundid)->value('title');?></td>
                    ...
                    <a href="{{route('delete_pp',['id'=>$t->id])}}" onclick='return confirm("Are you sure to Delete ?")' class="btn btn-outline-danger btn-sm">Delete</a>
                    </td>
                    </tr>
                    <?php $i++;
                    endforeach;
             ...
             <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('pptpanel/edit')}}">
        </div>
    </div>
  </div>
...
<div class="modal-content">
      ...
      <form class="form-horizontal" role="form" method="POST" action="{{ route('pptpaneladd') }}">
      {{ csrf_field() }}
      <div class='form-group'>
        <label for='type' class='col-xs-4 control-label'>DHI Fund<font color="red">*</font></label>
          <select class='form-control' id="training" name="fundname" required="required">
           <option value="">Select</option>
           <?php
           $training=App\Models\Funding::all();
...
<div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('updateppt_panelmember') }}">
          {{ csrf_field() }}
          <div class='form-group'>
        <label for='type' class='col-xs-4 control-label'>DHI Fund<font color="red">*</font></label>
          <select class='form-control' id="efundname" name="fundname" required="required">
           <option value="">Select</option>
           <?php
           $training=App\Models\Funding::all();
           foreach($training as $tr):
