<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container">
                    ...
                    <strong>Short Lsiting Status for <font color = 'blue'>{{ $application->name }}</font></strong>
                    </nav>
                    <form class="row g-3" role="form" method="POST" action="{{ route('fshortlistupdate') }}" enctype="multipart/form-data" id="scoreFundForm">
                            {{ csrf_field() }}
                                ...
                                <table id="myTable" class="table table-bordered table-sm table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($avg_score != 0.00)
                                            {{$avg_score}}
                                            @endif</td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">Export/Import </td>
                                            <td><a class="bbtn btn-primary btn-sm" href="{{ route('exportfund', $application->fundid) }}" style="text-decoration: none;">Export Score Sheet</a></td>
                                            <td>
    ...
    function validateAndConfirm(){
        ...
        $('#scoreFundForm :input[required]').each(function() {
        if (!$(this).val().trim()) {
            isValid = false;
