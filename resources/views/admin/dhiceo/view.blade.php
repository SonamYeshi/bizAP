  ...
  <div class="container">
    <div class="row">
        <div class="col-md-12 mt-5">
            ...
            <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('ceo/view')}}">
        </div>
    </div>
  </div>
...
<div class="modal-content">
        <div class="modal-header"><h5 class="modal-title" id="myModalLabel">Update CEO Name</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('update_ceo') }}">
          {{ csrf_field() }}
          <div class="form-group">
          <label for="ename" class="col-xs-4 control-label">Name<font color="red">*</font></label>
          <div class="col-xs-6">
          <input id="ceoname" type="text" class="form-control" name="uname" required="required">
          </div>
          </div>
