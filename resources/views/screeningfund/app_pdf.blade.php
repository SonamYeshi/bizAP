...
<div class="bg-light d-flex justify-content-between">
    <div>
    <strong>Fund Applied for:&nbsp;
    {{$application->fund_name}}
    </strong>
    </div>
</div>
  </div>
