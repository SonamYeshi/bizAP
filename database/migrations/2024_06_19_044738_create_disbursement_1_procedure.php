...
class CreateDisbursement1Procedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = '
            CREATE PROCEDURE `disbursement_1`()
            BEGIN
                ...
                WHERE app.disbursement = \'1\' AND app.cohortopen = \'COHORT\'
                GROUP BY app.cid 
                ORDER BY app.id DESC;
            END
        ';

        DB::unprepared("DROP PROCEDURE IF EXISTS `disbursement_1`");
