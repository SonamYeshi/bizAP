...
class CreateDisbursementdetailsProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = '
            CREATE PROCEDURE `disbursementdetails`(IN id INT(11))
            BEGIN
                ...
                WHERE app.disbursement = \'1\' AND app.id = id
                GROUP BY app.cid;
            END
        ';

        DB::unprepared("DROP PROCEDURE IF EXISTS `disbursementdetails`");
