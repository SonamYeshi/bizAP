...
class CreateDisbursement22Procedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = '
            CREATE PROCEDURE `disbursement_22`(IN id INT(11))
            BEGIN
                ...
                WHERE app.disbursement = \'1\' AND app.cohortopen = \'OPEN\' AND app.cohortopenno = id
                GROUP BY app.cid 
                ORDER BY app.id DESC;
            END
        ';

        DB::unprepared("DROP PROCEDURE IF EXISTS `disbursement_22`");
