...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['id' => 133, 'phone_code' => 389, 'country_code' => 'MK', 'country_name' => 'North Macedonia'],
            ...
            ['id' => 144, 'phone_code' => 262, 'country_code' => 'YT', 'country_name' => 'Mayotte'],
            ...
            ['id' => 159, 'phone_code' => 687, 'country_code' => 'NC', 'country_name' => 'New Caledonia'],
            ['id' => 160, 'phone_code' => 64, 'country_code' => 'NZ', 'country_name' => 'New Zealand'],
            ['id' => 161, 'phone_code' => 505, 'country_code' => 'NI', 'country_name' => 'Nicaragua'],
            ['id' => 162, 'phone_code' => 227, 'country_code' => 'NE', 'country_name' => 'Niger'],
            ['id' => 163, 'phone_code' => 234, 'country_code' => 'NG', 'country_name' => 'Nigeria'],
            ['id' => 164, 'phone_code' => 683, 'country_code' => 'NU', 'country_name' => 'Niue'],
            ['id' => 165, 'phone_code' => 672, 'country_code' => 'NF', 'country_name' => 'Norfolk Island'],
            ['id' => 166, 'phone_code' => 1670, 'country_code' => 'MP', 'country_name' => 'Northern Mariana Islands'],
            ['id' => 167, 'phone_code' => 47, 'country_code' => 'NO', 'country_name' => 'Norway'],
            ['id' => 168, 'phone_code' => 968, 'country_code' => 'OM', 'country_name' => 'Oman'],
            ['id' => 169, 'phone_code' => 92, 'country_code' => 'PK', 'country_name' => 'Pakistan'],
            ['id' => 170, 'phone_code' => 680, 'country_code' => 'PW', 'country_name' => 'Palau'],
            ['id' => 171, 'phone_code' => 970, 'country_code' => 'PS', 'country_name' => 'Palestinian Territory, Occupied'],
            ['id' => 172, 'phone_code' => 507, 'country_code' => 'PA', 'country_name' => 'Panama'],
            ['id' => 173, 'phone_code' => 675, 'country_code' => 'PG', 'country_name' => 'Papua New Guinea'],
            ['id' => 174, 'phone_code' => 595, 'country_code' => 'PY', 'country_name' => 'Paraguay'],
            ['id' => 175, 'phone_code' => 51, 'country_code' => 'PE', 'country_name' => 'Peru'],
            ['id' => 176, 'phone_code' => 63, 'country_code' => 'PH', 'country_name' => 'Philippines'],
            ['id' => 177, 'phone_code' => 64, 'country_code' => 'PN', 'country_name' => 'Pitcairn'],
            ['id' => 178, 'phone_code' => 48, 'country_code' => 'PL', 'country_name' => 'Poland'],
            ['id' => 179, 'phone_code' => 351, 'country_code' => 'PT', 'country_name' => 'Portugal'],
            ['id' => 180, 'phone_code' => 1787, 'country_code' => 'PR', 'country_name' => 'Puerto Rico'],
            ['id' => 181, 'phone_code' => 974, 'country_code' => 'QA', 'country_name' => 'Qatar'],
            ['id' => 182, 'phone_code' => 383, 'country_code' => 'XK', 'country_name' => 'Republic of Kosovo'],
            ['id' => 183, 'phone_code' => 262, 'country_code' => 'RE', 'country_name' => 'Reunion'],
            ['id' => 184, 'phone_code' => 40, 'country_code' => 'RO', 'country_name' => 'Romania'],
            ['id' => 185, 'phone_code' => 7, 'country_code' => 'RU', 'country_name' => 'Russian Federation'],
            ...
            ['id' => 191, 'phone_code' => 590, 'country_code' => 'MF', 'country_name' => 'Saint Martin (French part)'],
            ...
            ['id' => 194, 'phone_code' => 685, 'country_code' => 'WS', 'country_name' => 'Samoa'],
            ...
            ['id' => 200, 'phone_code' => 248, 'country_code' => 'SC', 'country_name' => 'Seychelles'],
            ['id' => 201, 'phone_code' => 232, 'country_code' => 'SL', 'country_name' => 'Sierra Leone'],
            ['id' => 202, 'phone_code' => 65, 'country_code' => 'SG', 'country_name' => 'Singapore'],
            ['id' => 203, 'phone_code' => 1721, 'country_code' => 'SX', 'country_name' => 'Sint Maarten (Dutch part)'],
            ['id' => 204, 'phone_code' => 421, 'country_code' => 'SK', 'country_name' => 'Slovakia'],
            ['id' => 205, 'phone_code' => 386, 'country_code' => 'SI', 'country_name' => 'Slovenia'],
            ['id' => 206, 'phone_code' => 677, 'country_code' => 'SB', 'country_name' => 'Solomon Islands'],
            ['id' => 207, 'phone_code' => 252, 'country_code' => 'SO', 'country_name' => 'Somalia'],
            ['id' => 208, 'phone_code' => 27, 'country_code' => 'ZA', 'country_name' => 'South Africa'],
            ['id' => 209, 'phone_code' => 500, 'country_code' => 'GS', 'country_name' => 'South Georgia and the South Sandwich Islands'],
            ['id' => 210, 'phone_code' => 211, 'country_code' => 'SS', 'country_name' => 'South Sudan'],
            ['id' => 211, 'phone_code' => 34, 'country_code' => 'ES', 'country_name' => 'Spain'],
            ['id' => 212, 'phone_code' => 94, 'country_code' => 'LK', 'country_name' => 'Sri Lanka'],
            ['id' => 213, 'phone_code' => 249, 'country_code' => 'SD', 'country_name' => 'Sudan'],
            ['id' => 214, 'phone_code' => 597, 'country_code' => 'SR', 'country_name' => 'Suriname'],
            ['id' => 215, 'phone_code' => 47, 'country_code' => 'SJ', 'country_name' => 'Svalbard and Jan Mayen'],
            ['id' => 216, 'phone_code' => 268, 'country_code' => 'SZ', 'country_name' => 'Swaziland'],
            ['id' => 217, 'phone_code' => 46, 'country_code' => 'SE', 'country_name' => 'Sweden'],
            ['id' => 218, 'phone_code' => 41, 'country_code' => 'CH', 'country_name' => 'Switzerland'],
            ['id' => 219, 'phone_code' => 963, 'country_code' => 'SY', 'country_name' => 'Syrian Arab Republic'],
            ['id' => 220, 'phone_code' => 886, 'country_code' => 'TW', 'country_name' => 'Taiwan, Province of China'],
            ['id' => 221, 'phone_code' => 992, 'country_code' => 'TJ', 'country_name' => 'Tajikistan'],
            ['id' => 222, 'phone_code' => 255, 'country_code' => 'TZ', 'country_name' => 'Tanzania, United Republic of'],
            ['id' => 223, 'phone_code' => 66, 'country_code' => 'TH', 'country_name' => 'Thailand'],
            ['id' => 224, 'phone_code' => 670, 'country_code' => 'TL', 'country_name' => 'Timor-Leste'],
            ['id' => 225, 'phone_code' => 228, 'country_code' => 'TG', 'country_name' => 'Togo'],
            ['id' => 226, 'phone_code' => 690, 'country_code' => 'TK', 'country_name' => 'Tokelau'],
            ['id' => 227, 'phone_code' => 676, 'country_code' => 'TO', 'country_name' => 'Tonga'],
            ['id' => 228, 'phone_code' => 1868, 'country_code' => 'TT', 'country_name' => 'Trinidad and Tobago'],
            ['id' => 229, 'phone_code' => 216, 'country_code' => 'TN', 'country_name' => 'Tunisia'],
            ['id' => 230, 'phone_code' => 90, 'country_code' => 'TR', 'country_name' => 'Turkey'],
            ['id' => 231, 'phone_code' => 993, 'country_code' => 'TM', 'country_name' => 'Turkmenistan'],
            ['id' => 232, 'phone_code' => 1649, 'country_code' => 'TC', 'country_name' => 'Turks and Caicos Islands'],
            ['id' => 233, 'phone_code' => 688, 'country_code' => 'TV', 'country_name' => 'Tuvalu'],
            ['id' => 234, 'phone_code' => 256, 'country_code' => 'UG', 'country_name' => 'Uganda'],
            ['id' => 235, 'phone_code' => 380, 'country_code' => 'UA', 'country_name' => 'Ukraine'],
            ['id' => 236, 'phone_code' => 971, 'country_code' => 'AE', 'country_name' => 'United Arab Emirates'],
            ['id' => 237, 'phone_code' => 44, 'country_code' => 'GB', 'country_name' => 'United Kingdom'],
            ['id' => 238, 'phone_code' => 1, 'country_code' => 'US', 'country_name' => 'United States'],
            ['id' => 239, 'phone_code' => 598, 'country_code' => 'UY', 'country_name' => 'Uruguay'],
            ['id' => 240, 'phone_code' => 998, 'country_code' => 'UZ', 'country_name' => 'Uzbekistan'],
            ['id' => 241, 'phone_code' => 678, 'country_code' => 'VU', 'country_name' => 'Vanuatu'],
            ['id' => 242, 'phone_code' => 58, 'country_code' => 'VE', 'country_name' => 'Venezuela'],
            ['id' => 243, 'phone_code' => 84, 'country_code' => 'VN', 'country_name' => 'Vietnam'],
            ['id' => 244, 'phone_code' => 1284, 'country_code' => 'VG', 'country_name' => 'Virgin Islands, British'],
            ['id' => 245, 'phone_code' => 1340, 'country_code' => 'VI', 'country_name' => 'Virgin Islands, U.S.'],
            ['id' => 246, 'phone_code' => 681, 'country_code' => 'WF', 'country_name' => 'Wallis and Futuna'],
            ['id' => 247, 'phone_code' => 212, 'country_code' => 'EH', 'country_name' => 'Western Sahara'],
            ['id' => 248, 'phone_code' => 967, 'country_code' => 'YE', 'country_name' => 'Yemen'],
            ['id' => 249, 'phone_code' => 260, 'country_code' => 'ZM', 'country_name' => 'Zambia'],
            ['id' => 250, 'phone_code' => 263, 'country_code' => 'ZW', 'country_name' => 'Zimbabwe'],
        ];

        // Insert data into the table
        DB::table('tbl_countries')->insert($data);
    }
}
